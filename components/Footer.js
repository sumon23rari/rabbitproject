...
import Link from 'next/link';
 function Footer() {
  ...
  return (
    <div>
      <div style={{background:'linear-gradient(254.81deg,#333 8.13%,#171717 92.46%)',padding:' 40px  0'}}>
      <div className="container">
    <footer className={`footer footermid text-neutral-content ${footerst.footdiv}`} >

    <div className={`${footerst.footdiv1}`}>
      <span className="footer-title opacity-100 mb-6">
        <Image src={logo} alt="logo"></Image>
        </span> 
    <div className='font-semibold  hover:cursor-pointer pb-3'>
    ...
    <div className={`${footerst.footdiv2}`}>
...
<Link href="/Catagories" className='capitalize font-medium text-md'>Catagories</Link>
    ...
    <div className={footerst.footdiv4}>
      <span  className={footerst.footerTitle4}>Legal</span> 
    ...
    <div className={footerst.footdiv5}>
      <span className={footerst.footerTitle5}>Download</span> 
